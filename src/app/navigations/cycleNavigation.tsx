            ...
            <NativeBaseProvider>
                <ProcessStack.Navigator >
                    <ProcessStack.Screen name="Cycles" options={{
                        title: 'Cycles', headerTintColor: '#32404e', headerTitleStyle: { fontSize: 20, fontWeight: 'bold' },
                    }} component={cycleList} />
                    <ProcessStack.Screen name="Settings" options={{
                        title: 'Settings', headerTintColor: '#32404e', headerTitleStyle: { fontSize: 20, fontWeight: 'bold' }
                    }} component={cycleSettings} />
                    <ProcessStack.Screen name="SequenceSettings" options={{
                        title: 'Sequence', headerTintColor: '#32404e', headerTitleStyle: { fontSize: 20, fontWeight: 'bold' }
