...
export function PlanStack() {
    const options = (title: string) => ({headerTitleAlign: 'center',orientation:'landscape', animation: 'none', title: title, headerTintColor: '#32404e', headerTitleStyle: { fontSize: 20, fontWeight: 'bold' },headerShown: false } as NativeStackNavigationOptions);
    const Stack = createNativeStackNavigator();
    return (
        <Stack.Navigator screenOptions={{ animation: 'none' }}>
            <Stack.Screen name="Plan" component={PlanScreen} options={options('Plan')} />
