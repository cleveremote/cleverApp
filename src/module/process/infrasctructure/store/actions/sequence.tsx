...
export const updateSequence =
	(sequence: any): ThunkAction<void, RootState, unknown, AnyAction> =>
	dispatch => {
		dispatch({
...
export const loadSequences =
	(sequenceId: any): ThunkAction<void, RootState, unknown, AnyAction> =>
	dispatch => {
		dispatch({
			type: SEQUENCES_LOAD,
			payload: sequenceId
...
export const loadSequence =
	(sequenceId: string): ThunkAction<void, RootState, unknown, AnyAction> =>
	dispatch => {
		dispatch({
			type: SEQUENCE_LOAD,
			payload: sequenceId
