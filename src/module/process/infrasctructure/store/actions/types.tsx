/////////////MOSBUS_CONNECTION
export const MODBUS_CONNECTIONS_LOAD = 'MODBUS_CONNECTIONS_LOAD';
export const MODBUS_CONNECTION_LOAD = 'MODBUS_CONNECTION_LOAD';
export const MODBUS_CONNECTION_UPDATE = 'MODBUS_CONNECTION_UPDATE';
export const MODBUS_CONNECTION_SAVE = 'MODBUS_CONNECTION_SAVE';

/////////////MOSBUS_TASK
export const MODBUS_TASKS_LOAD = 'MODBUS_TASKS_LOAD';
export const MODBUS_TASK_LOAD = 'MODBUS_TASK_LOAD';
export const MODBUS_TASK_UPDATE = 'MODBUS_TASK_UPDATE';
export const MODBUS_TASK_SAVE = 'MODBUS_TASK_SAVE';
...
export const CYCLE_EXECUTE = 'CYCLE_EXECUTE';
...
export const MODULES_LOAD = 'MODULES_LOAD';
...
export const PROCESS_EXECUTION = 'PROCESS_EXECUTION';
export const CONNEXION_STATUS = 'CONNEXION_STATUS';

//states
export const SET_CONNECTED = 'SET_LOGGEDIN';
